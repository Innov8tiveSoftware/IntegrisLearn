...
$.VdgmVideoPlayer.prototype = {
    _assetPath: '/load/0.0.5-8366aa33/client/mod/videoplayer/assets/',
    ...
    bindUI: function () {
        ...
        this._video = videojs(this._playerId, {
            ...
            if (self.model.duration && self.model.video) {
                var thumbnailObj = {};

                if (self.model.preroll) {
                    thumbnailObj = self.generateThumbnails(self.model.preroll, 0);
                    thumbnailObj = $.extend(thumbnailObj, self.generateThumbnails(self.model, Number(self.model.preroll.duration)));

                    if (self.model.postroll) {
                        thumbnailObj = $.extend(thumbnailObj, self.generateThumbnails(self.model.postroll, Number(self.model.preroll.duration) + Number(self.model.duration)));
                    }
                }
                else {
                    thumbnailObj = self.generateThumbnails(self.model, 0);

                    if (self.model.postroll) {
                        thumbnailObj = $.extend(thumbnailObj, self.generateThumbnails(self.model.postroll, Number(self.model.duration)));
                    }
                }
    ...
    generateThumbnails: function (video, offset) {
        //var numThumbnails = Math.floor(video.duration / 10),
        //    videoPath = video.videos[0].url,
        ...
        //    thumbnailObj[j*10 + offset].width = '160px';
        //}
    ...
    _html_timeupdate: function (e) {
        ...
        if (this.model.type == 'live') {
            ...
            if (this.model.preroll && currentTime < this.model.preroll.duration && !this.tuTracker.preroll.complete) {
                ...
                if (this.tuTracker.video.start != true) {
                    this.tuTracker.video.start = true;
                    this._track('Video', 'Start');
                }
 ...
 * @return {vjs.Player} self
 */
vjs.Player.prototype.stop = function () {
    this.techCall('stop');
    return this;
};
...
/**
*
*   myPlayer.flushBuffer();
*
* @return {vjs.Player} self
*/

vjs.Player.prototype.flushBuffer = function () {
    this.techCall('flushBuffer');
    return this;
};
 ...
 * @constructor
 */
vjs.StopToggle = vjs.Button.extend({
    /** @constructor */
    init: function (player, options) {
        vjs.Button.call(this, player, options);
    }
...
vjs.StopToggle.prototype.buttonText = 'Stop';

vjs.StopToggle.prototype.buildCSSClass = function () {
    return 'vjs-stop-control ' + vjs.Button.prototype.buildCSSClass.call(this);
};

// OnClick - Toggle between play and pause
vjs.StopToggle.prototype.onClick = function () {
    this.player_.trigger('stop');
};/**
...
/**
 * Toggle intermediate video
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @class
 * @extends vjs.Button
 */
vjs.IntermediateToggle = vjs.Button.extend({
    /**
     * @constructor
     * @memberof vjs.IntermediateToggle
     * @instance
     */
    init: function (player, options) {
        vjs.Button.call(this, player, options);
...
vjs.IntermediateToggle.prototype.buttonText = 'Intermediate Size';

vjs.IntermediateToggle.prototype.buildCSSClass = function () {
    return 'vjs-intermediate-control ' + vjs.Button.prototype.buildCSSClass.call(this);
};

vjs.IntermediateToggle.prototype.onClick = function () {
    if (this.player_.isFullscreen())
        this.player_.exitFullscreen();

    this.player_.trigger('intermediateToggle');
};
/**
 * Toggle intermediate video
 * @param {vjs.Player|Object} player
 ...
 * @extends vjs.Button
 */
vjs.HdToggle = vjs.Button.extend({
    /**
     * @constructor
     * @memberof vjs.HDToggle
     * @instance
     */
    init: function (player, options) {
        vjs.Button.call(this, player, options);
...
vjs.HdToggle.prototype.buttonText = 'HD Video';

vjs.HdToggle.prototype.buildCSSClass = function () {
    return 'vjs-hd-control ' + vjs.Button.prototype.buildCSSClass.call(this);
};

vjs.HdToggle.prototype.updateContent = function () {
    if (this.player_.techName == 'Flash') {
        if (this.player_.tech.videoHeight() >= 720) {
            vjs.removeClass(this.el_, 'vjs-videosize-standard');
            vjs.addClass(this.el_, 'vjs-videosize-hd');
        }
        else {
            vjs.removeClass(this.el_, 'vjs-videosize-hd');
            vjs.addClass(this.el_, 'vjs-videosize-standard');
        }
    }
    else {
        vjs.addClass(this.el_, 'vjs-videosize-hidden');
    }
};
/**
...
vjs.LoadingSpinner = vjs.Component.extend({
    ...
    init: function (player, options) {
        ...
        player.on('canplay', vjs.bind(this, this.stopCounter));
        ...
        player.on('ended', vjs.bind(this, this.stopCounter));

        // Not showing spinner on stalled any more. Browsers may stall and then not trigger any events that would remove the spinner.
        // Checked in Chrome 16 and Safari 5.1.2. http://help.videojs.com/discussions/problems/883-why-is-the-download-progress-showing
        // player.on('stalled', vjs.bind(this, this.show));

        player.on('waiting', vjs.bind(this, this.startCounter));
    }
});

vjs.LoadingSpinner.prototype.startCounter = function () {
    this.timers.push(setTimeout(vjs.bind(this, this.show), 500));
};

vjs.LoadingSpinner.prototype.stopCounter = function () {
...
vjs.LoadingSpinner.prototype.createEl = function () {
    return vjs.Component.prototype.createEl.call(this, 'div', {
        ...
        innerHTML: '<span class="vjs-spinner"></span>'
    });
};
/* Big Play Button
================================================================================ */
...
vjs.MediaTechController.prototype.manualTimeUpdatesOff = function (dispose) {
    var player = this.player_;

    this.manualTimeUpdates = false;
    this.stopTrackingCurrentTime(dispose);
...
vjs.MediaTechController.prototype.stopTrackingCurrentTime = function (dispose) {
...
vjs.MediaTechController.prototype.dispose = function () {
    ...
    if (this.manualTimeUpdates) { this.manualTimeUpdatesOff(true); }
...
vjs.Html5.prototype.stop = function () { vjs.log("Stop called for HTML"); };
vjs.Html5.prototype.flushBuffer = function () { };
...
vjs.Flash.prototype.stop = function () {
    vjs.log("Stop called for Flash");
};

vjs.Flash.prototype.flushBuffer = function () {
    this.el_.vjs_flushBuffer();
};
...
(function () {
    ...
    vjs.ChromecastComponent = (function (superClass) {
        ...
        ChromecastComponent.prototype.ended = false;
        ...
        ChromecastComponent.prototype.currentTech = "";

        ChromecastComponent.prototype.currentSrc = "";
        ...
        ChromecastComponent.prototype.initializeApi = function () {
            ...
            if (!chrome.cast || !chrome.cast.isAvailable) {
                ...
                this.timer = setTimeout(this.initializeApi.bind(this), 1000);
                return;
            }
        ...
        ChromecastComponent.prototype.onMediaDiscovered = function (media) {
            ...
            this.currentTech = this.player_.techName;
            this.currentSrc = this.player_.src;
        ...
        ChromecastComponent.prototype.onStopAppSuccess = function () {
            ...
            this.player_.loadTech(this.currentTech, this.currentSrc);
            /*if (!this.paused) {
    ...
    vjs.ChromecastTech = (function (superClass) {
        ...
        ChromecastTech.prototype.dispose = function () {
            clearInterval(this.player_.chromecastComponent.timer);

            if (this.player_.chromecastComponent.casting) {
                this.player_.chromecastComponent.apiSession.stop(function () { }, this.player_.chromecastComponent.onError);
                this.player_.chromecastComponent.casting = false;
                this.player_.chromecastComponent.removeClass("connected");
            }
        ...
        ChromecastTech.prototype.flushBuffer = function () { };
        ...
        ChromecastTech.prototype.ended = function () {
            return this.player_.chromecastComponent.ended;
        }
...
(function () {
    ...
    videojs.plugin('thumbnails', function (options) {
        ...
        progressControl = player.controlBar.progressControl;
        //progressControl.el().appendChild(div); //< not supported; disabled 12/2/2015 by Cristian F
        ...
        moveListener = function (event) {
            ...
            if ((left + halfWidth + 4) > right) {
                left -= (left + halfWidth + 4) - right;
            } else if (left < halfWidth + 4) {
                left = halfWidth + 4;
            }
